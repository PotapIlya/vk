    ...
    <div class="d-flex flex-column w-100">
        <form class="was-validated">
            ...
            <div class="mb-3 d-flex align-items-center">
                ...
                <input name="first_name" type="text" class="form-control" id="validationTooltip01" value="{{ $user->name }}" placeholder="Ваше имя" required>
            </div>
            <div class="mb-3 d-flex align-items-center">
                <label for="validationTooltip01" class="mr-3 my-0">Фамилия</label>
                <input name="last_name" type="text" class="form-control" id="validationTooltip01" value="{{ $user->name }}" placeholder="Ваша фамилия" required>
            </div>
           ...
           <div class="d-flex align-items-center mb-3">
            ...
            <div class="mb-3">
                <div class="input-group is-invalid">
                    ...
                    <input type="text" value="{{ $user->name }}" class="form-control is-invalid" aria-describedby="validatedInputGroupPrepend" required>
                </div>
            </div>
